...
type LoginServiceClient interface {
	...
	Register(ctx context.Context, in *RegisterMessage, opts ...grpc.CallOption) (*RegisterMessage, error)
}
...
func (c *loginServiceClient) Register(ctx context.Context, in *RegisterMessage, opts ...grpc.CallOption) (*RegisterMessage, error) {
...
type LoginServiceServer interface {
	...
	Register(context.Context, *RegisterMessage) (*RegisterMessage, error)
...
func (UnimplementedLoginServiceServer) Register(context.Context, *RegisterMessage) (*RegisterMessage, error) {
